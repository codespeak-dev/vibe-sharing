...
describe("Feature: Claude Code Plugin — Archive Creation", () => {
  ...
  test.skip(
    "Secrets protection message includes best effort qualifier: the '(best effort)' qualifier is shown by the plugin's pre-archive message; plugin source lives outside this repo",
    () => {},
  );
  test.skip(
